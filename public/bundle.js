...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListContainer = __webpack_require__(5);
	...
	var App = React.createClass({
	  ...
	  onAdded: function onAdded(index, title, color) {
	    // Use an Immutable Map for this shiz
	    this.setState({
	      lists: this.state.lists.concat({ title: title, index: index, color: color })
	    });
	  },
	  ...
	  onRemove: function onRemove(index) {
	    ...
	    var index = 0;
	    this.setState({
	      lists: newList.map(function (list) {
	        list.index = index++;
	        return list;
	      })
	    });
	  ...
	  render: function render() {
	    ...
	    var showLists = this.state.lists.map(function (list) {
	      return React.createElement(
	        "div",
	        { key: list.index },
	        React.createElement(ListContainer, { title: list.title, color: list.color, onRemove: _this.onRemove.bind(_this, list.index) })
	      );
	    });
	    ...
	    return React.createElement(
	      "div",
	      { className: "container" },
	      React.createElement(AddList, { onAdd: this.onAdded.bind(this, this.state.lists.length) }),
	      showLists
	    );
	  }
	});
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var listItems = this.props.items.map(function (item, index) {
	      return React.createElement(
	        "li",
	        { className: "list-group-item", styles: styles.listGroup, key: index },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddItem = _interopRequire(__webpack_require__(4));
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var list = Object.keys(colors).map(function (key) {
	      var localStyle = JSON.parse(JSON.stringify(styles.color));
	      localStyle.background = colors[key];
	      return React.createElement("span", { style: localStyle, key: key, onClick: _this.handleColor.bind(_this, localStyle.background) });
	    });
	    ...
	    return React.createElement(
	      ...
	      React.createElement("span", { style: currentColorStyle }),
	      React.createElement("br", null),
	      list,
	      React.createElement("br", null),
	      React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = _interopRequire(__webpack_require__(1));
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("span", { className: "glyphicon glyphicon-remove", style: styles.remove, onClick: this.handleRemove }),
	        React.createElement(
	          "h3",
	          { className: "text-center" },
	          " ",
	        ...
	        React.createElement(AddItem, { onAddItem: this.handleAddItem }),
	        React.createElement(List, { onRemoveItem: this.handleRemoveItem, items: this.state.list })
	      )
	    );
	  }
